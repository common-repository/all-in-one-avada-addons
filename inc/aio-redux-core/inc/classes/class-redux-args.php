		...
		private function no_errors_please( $args ) {
			...
			if ( empty( $args['footer_credit'] ) ) {
				...
				/* translators: 1: Redux, 2: Link to plugin review */
					...
					'<strong>' . __( 'All in One Avada Addons', 'redux-framework' ) . '</strong>',
					'<a href="https://wordpress.org/support/plugin/all-in-one-avada-addons/reviews/?filter=5/#new-post" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a>'
				);
